...
class TickData:
    ...
    def __init__(self, open=None, high=None, low=None, close=None, volume=None, timestamp=None, symbol=None, time_increment="1m"):
        self.open = open
        self.high = high
        self.low = low
        self.close = close
        ...
        self.time_increment = time_increment  # Add time_increment attribute with default of "1m"
